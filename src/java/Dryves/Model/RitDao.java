...
public class RitDao {
	...
	public Boolean saveMeerdereRitten() {
		...
		for (int i = 0; i < dagenVdWeek.size(); i++) {
			...
			while (it.hasNext()) {
				...
				PreparedStatement insertRit = null;
	...
	* @return
	 * @throws SQLException
	 */
	public List<Rit> getAlleRittenPerLid(int offset) {
...
* @return
	 ...
	 * @throws SQLException
	 */
	public int aantalRitten(int lidnr) {
	...
	/**
	 * Deze methode wordt gebruikt om het aantal zoekresultaten op te halen
	 *
	 * @param startpunt en eindpunt
	 * @return int
	 */
	public int aantalZoekRitten(String startpunt, String eindpunt) {
		int aantal = 0;
		Connection connection = null;
		//PreparedStatement statement = null;
		ResultSet resultSet = null;
	 ...
	 * @throws SQLException
	 */
	public List<Rit> getAlleRitten(String startpunt, String eindpunt, int offset) {
		Connection connection = null;
		//PreparedStatement statement = null;
		ResultSet resultSet = null;
		List<Rit> ritten = new ArrayList<Rit>();
