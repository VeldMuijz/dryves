...
<html>
    <head>
        ...
        <title>Helaas, rit niet meer beschikbaar</title><script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js">
        </script>
 <script>
                            function redirect(){
...
<a  href="MijnDryves"></a>
        ...
        <div class="drvyesWrapper">
            ...
            <div class="contentPanel">                                                 
                <h1><fmt:message bundle="${rb}" key="nietmeerbeschikbaar" /></h1>
                <br><br>                                                    
                    <p> </p>
                </div>        
        </div>
